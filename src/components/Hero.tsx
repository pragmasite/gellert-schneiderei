...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-16 flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute -left-20 bottom-1/4 h-80 w-80 rounded-full bg-secondary/20 blur-3xl"
        />
      </div>
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <motion.h1
          ...
          className="mb-6 max-w-4xl font-serif text-5xl font-bold text-white md:text-6xl lg:text-7xl leading-tight"
        >
          {t.hero.title1}
          <br />
        ...
        >
          ...
          >
            <a href="mailto:shekhuahmad85@gmail.com" className="flex items-center gap-2">
